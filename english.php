...
/* Changes in 3.4.0 */
$_LANG['stream_output_nexists'] = 'Stream Output format does not exists';
$_LANG['stream_transcode'] = 'Select Transcode Method';
$_LANG['transcode_nexists'] = 'Selected Transcode Method Does not exists!';
$_LANG['stream_start_error'] = 'IPTV Panel was unable to start the stream in all of your selected server(s). Please see the panel logs. Possible error could be that some of your servers are offline at the moment.';
$_LANG['stream_stopped'] = 'Stream(s) Stopped Successfully!';
$_LANG['stream_stopped_error'] = 'Stream(s) Stopped Error! Not every pid has been closed. Please see the Panel Logs for Possible Errors!';
$_LANG['stream_restarted'] = "Stream Restarted Successfully!";
$_LANG['stream_restart_error'] = 'Unable to restart the stream.';
$_LANG['stream_closed_unexp'] = 'Closed Unexpectedly - Rechecking';
$_LANG['movies'] = 'VOD (Video On Demand)';
$_LANG['new_movie'] = 'Add New Movie';
$_LANG['manage_movies'] = 'Manage Movies';
$_LANG['movies_options'] = 'Movies Options';
$_LANG['movie_name'] = 'Movie Name';
$_LANG['subtitles_not_exists'] = 'Subtitles file does not exists';
$_LANG['movie_source'] = 'Movie Source';
$_LANG['movie_subtitles'] = 'Movie Subtitles';
$_LANG['movie_deleted'] = 'Movie Deleted';
$_LANG['delete_movie'] = 'Delete this movie';
$_LANG['in_progress'] = 'In Progress';
$_LANG['verify'] = 'Verification';
$_LANG['interrupted'] = 'Interrupted';
$_LANG['movie_edited'] = 'Movie Edited. You may need to RE-Make it if you changed the transcode attributes or subtitles. Otherwise don\'t take any action';
$_LANG['edit_movie'] = 'Edit Movie';
$_LANG['bad_movie'] = 'Bad Movie';
$_LANG['movie'] = 'Movie';
$_LANG['live'] = 'Live';
$_LANG['movie_id_nexists'] = 'Movie Does NOT exists';
$_LANG['select_streams'] = 'Select Streams / Movies';
$_LANG['live_streams_select'] = 'Select Live Streams';
$_LANG['movies_select'] = 'Select Movies';
$_LANG['your_bouquet'] = 'Your Bouquet';
$_LANG['debug'] = 'Debug';
$_LANG['streams_stoped_success'] = 'All streams stopped.';
$_LANG['streams_started'] = 'All Streams Started Successfully';
$_LANG['movie_options'] = 'Movie Options';

//changes in 1.0.18

//total_running_streams
//fix_optimize_database
//backup_tables
$_LANG['please_wait_ajax'] = 'Please wait for this process to be completed. It can take a while. Do not close this window !';
$_LANG['backup_database'] = 'Backup Database';
$_LANG['bitrate'] = 'BitRate';
$_LANG['server_search'] = 'Server';
$_LANG['type_search'] = 'Container';
$_LANG['transcoding'] = 'Transcoding';
$_LANG['next'] = '>> Next';
$_LANG['previous'] = '>> Previous';
$_LANG['last_updated'] = 'Last Updated';
$_LANG['never'] = 'Never';
$_LANG['more_than_1'] = 'You need to import more than 1 video files to create a channel. If you have only 1 Video file then you can import it directly as a live stream.';
$_LANG['epg_force_reload'] = 'EPG Updated.';
$_LANG['reload'] = 'Reload';
$_LANG['total_epg_data'] = 'Total EPG Data';
$_LANG['delete_subtitles'] = 'Delete Existing Subtitles';
$_LANG['movie_exists'] = 'Movie with the same name already exists. Please choose another';
$_LANG['delete_subtitles_help'] = 'In case your Video file has subtitles on it you may wish to remove them so that you can embed your own. Please note that this setting will not delete EMBED subtitles. EMBED subtitles are those that are encoded into the Video';
$_LANG['read_native_live'] = 'You should always read LIVE Streams as non-native frames so the default should be the best. However if you are streaming static VIDEO files , for example movies, set this to YES otherwise the encoding process will be instant finished';


$_LANG['ffmpeg_old_ver'] = 'You are using an earlier FFmpeg version with this Panel. You may have problems. Please contact us with tickets to fix that';
$_LANG['ffprobe_old_ver'] = 'You are using an earlier FFprobe version with this Panel. You may have problems. Please contact us with tickets to fix that';
$_LANG['bin_not_exec'] = 'FFmpeg/FFprobe is not executable. Please contact us using tickets to fix that';
$_LANG['too_low_analyze'] = 'Your analyze Stream duration is too low. You may notice strange bahaviour of streams. You can increase that amount under General Settings';
$_LANG['too_low_probesize'] = 'Your probesize value is too low. You may notice strange bahaviour of streams. You can increase that amount under General Settings';
$_LANG['combiner_not_executable'] = 'Your combiner.sh script is not executable. Please chmod it or contact us using tickets to fix that';
